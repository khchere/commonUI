...
class _LoadingState extends State<Loading> {
  ...
  void initState() {
    super.initState();
    widget.controller?._showsLoadingIndicator
        ?.addListener(_handleShowsLoadingIndicator);
  ...
  void dispose() {
    widget.controller?._showsLoadingIndicator
        ?.removeListener(_handleShowsLoadingIndicator);
    ...
    return Stack(
      children: <Widget>[
        ...
        if (_isShowLoadingIndicator)
          Material(color: widget.backgroundColor, child: indicator),
      ],
    );
  }
}
